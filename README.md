...
## 任务
### 机械篇
- 以下有3个TASK,其中TASK1为环境相关，TASK2为基础任务，TASK3为附加任务。建议机械组尽快完成TASK1与TASK2，方便电路组与软件组同学后续调试。
...
- TASK3：**附加任务**\
  我们所做的一切的一切都是为了做出一个完整的产品，而完整的产品要求好的封装。你需要设计出一个外壳，尽可能地包裹住内部的电路、杜邦线
  (1)：这只是附加任务，你设计的小狗外壳不应干扰小狗的正常功能
  (2)：你所设计的外壳要稳定，不能存在走几步就松动的情况
  (3)：小狗外壳要方便拆解，不能直接用胶水粘上，这样不方便后续调试
